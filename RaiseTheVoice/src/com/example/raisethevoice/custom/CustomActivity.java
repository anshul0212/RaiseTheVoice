package com.example.raisethevoice.custom;



import com.example.raisethevoice.utility.TouchEffect;
...
public class CustomActivity extends FragmentActivity implements OnClickListener
{
	...
	protected void setupActionBar()
	{
		...
		if (actionBar == null)
			return;
		actionBar.setIcon(new ColorDrawable(Color.parseColor("#00FFFFFF")));
